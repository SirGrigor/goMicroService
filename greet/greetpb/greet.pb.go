...
type GreatManyTimesResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GreatManyTimesResponse) Reset() {
	*x = GreatManyTimesResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GreatManyTimesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreatManyTimesResponse) ProtoMessage() {}

func (x *GreatManyTimesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreatManyTimesResponse.ProtoReflect.Descriptor instead.
func (*GreatManyTimesResponse) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{4}
}

func (x *GreatManyTimesResponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x22, 0x30, 0x0a, 0x16, 0x47, 0x72, 0x65, 0x61, 0x74, 0x4d,
	...
	0x1d, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x61, 0x74, 0x4d, 0x61, 0x6e,
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*GreatManyTimesResponse)(nil), // 4: greet.GreatManyTimesResponse
}
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	4, // 5: greet.GreetService.GreetManyTimes:output_type -> greet.GreatManyTimesResponse
...
func file_greet_greetpb_greet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greet_greetpb_greet_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GreatManyTimesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type GreetService_GreetManyTimesClient interface {
	Recv() (*GreatManyTimesResponse, error)
	grpc.ClientStream
}
...
func (x *greetServiceGreetManyTimesClient) Recv() (*GreatManyTimesResponse, error) {
	m := new(GreatManyTimesResponse)
...
type GreetService_GreetManyTimesServer interface {
	Send(*GreatManyTimesResponse) error
	grpc.ServerStream
}
...
func (x *greetServiceGreetManyTimesServer) Send(m *GreatManyTimesResponse) error {
